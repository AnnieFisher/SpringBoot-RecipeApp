...
create table recipe_category_list (recipe_id bigint not null, category_list varchar(255)) engine=InnoDB;
...
alter table recipe_category_list add constraint FK2gw457f0phv3qicg2c0y7l0hb foreign key (recipe_id) references recipe (id);
